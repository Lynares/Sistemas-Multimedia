...
/**
 * Clase que hereda de FiguraGeometrica y crea un rectángulo.
...
public class Rectangulo extends FiguraGeometrica {
    ...
    /**
     * Constructor
     * @param p1 double, primer punto del rectángulo.
     * @param p2 double, segundo punto del rectángulo.
     * @param p3 double, tercer punto del rectángulo.
     * @param p4 double, cuarto punto del rectángulo.
     */
    public Rectangulo(double p1, double p2, double p3, double p4){
        rect=new Rectangle2D.Double(p1, p2, p3, p4);
    }       
    /**
    ...
    /**
     * 
     * @return int con valor 2, que es el número asignado a la forma rectángulo.
     */
    @Override
    public int getForma() {
        return 2;
